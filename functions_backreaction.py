...
# I noticed that the gas and dust velocities are updated in the finalizer in the implicit scheme.
# If the integration scheme is explicit then this should (probably???) be called in the diastole.
def update_RadialVelocities(sim):
    sim.gas.v.update() # Updates viscous and radial velocity
    sim.dust.v.rad.update() # Updates the dust radial velocity right afterwards
